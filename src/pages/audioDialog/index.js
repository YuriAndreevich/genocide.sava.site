  ...
  return (
    <div className="audioDialog" id='audioDialog'>
      <div className="audioDialog-content">
        ...
        <Accordions
          title="Читать"
          body="Сегодня у нас в гостях малолетний узник концентрационного лагеря «Освенцим» Анатолий Владимирович Глевацкий. Он у нас работал мастером производственного обучения  - Здравствуйте, уважаемый Анатолий Владимирович! Мы благодарны, что Вы нашли время и желание пообщаться с нами, рассказать о себе!
