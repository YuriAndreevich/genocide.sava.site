    ...
    <div className="audioDialog" id="audioDialog">
      <div className="audioDialog-content">
        <div class="readMore">
          <input
            type="checkbox"
            class="read-more-checker2"
            id="read-more-checker2"
          />
          <div class="limited l-800">
            ...
            <Accordions
              ...
              body={
                <p id="p">
                  - Понятно, что с первых дней войны отец ушёл на фронт. Вскоре
                  беда постучалась и в дом Войцеховских: кто-то донёс, что муж
                  Галины – военный офицер. Вся семья была арестована. Есть ещё
                  одна версия случившемуся: дедушка был связан с подпольщиками,
                  которые планировали передать партию валенок партизанам.
                  Каким-то образом это стало известно фашистам. Так, осенью 1942
                  года вся наша семья была отправлена в тюрьму в район Задвинья.
                  <p id="p">
                    
                    - В начале 1943 года дедушку казнили, а нас всех отправили в
                    железнодорожный пункт в Громы для последующей отправки в
                    лагерь. Так мы попали в 9-ый Минский эшелон, где в товарных
                    вагонах везли людей из разных городов Витебской области и
                    Беларуси. Ехали мы в тяжёлых условиях: в тесноте, без воды,
                    делились едой с теми, кто успел её взять. Так мы ехали суток
                    трое, останавливаясь только для того, чтобы выбросить
                    умерших. И вот, 04. 12. 1943 мы с матерью и все родные
                    попали в Освенцим, а конкретно в лагерь Аушвиц II -
                    Биркенау. Заключённые сразу проходили обработку: их мыли,
                    обривали волосы, одевали в полосатую одежду, ставили номер
                    на руку… (Анатолий Владимирович показал номер на руке, цифры
                    которого, по мере взросления, расползлись на всё запястье).
                  </p>
                </p>
              }
            />
            <h2 id="p">
              - Анатолий Владимирович, в то время Вы были ещё совсем мал.
              Скажите, сохранились ли какие-то воспоминания о периоде в лагере.
            </h2>
            ...
            />
            <h2 id="p">
              - Анатолий Владимирович, как произошло, что Вас разлучили с
              матерью?
            </h2>
            ...
            <h2 id="p">
              ...
              - Расскажите, пожалуйста, каковы были условия жизни в детском
              лагере?
            </h2>
            ...
            <h2 id="p">
              ...
              - С Вами в детском лагере находились и Ваши малолетние
              родственники, тёти и дядя?
            </h2>
            ...
            />
            <h2 id="p">
              - Анатолий Владимирович, давайте вернёмся к тому периоду, когда
              Вас освободили из Тухенгема. Расскажите, пожалуйста, как же это
              произошло?
            </h2>
            ...
            />
            <h2 id="p">
              - Анатолий Владимирович, можете рассказать, где же Вы встретили
              жену?
            </h2>
...
"
            />
            <h2 id="p">
              - У Вас на столе лежат книги, много всяких документальных
              материалов. Расскажите, пожалуйста, о чём они?
            </h2>
            ...
            />
            <h2 id="p">
              - Анатолий Владимирович, когда мы с Вами договаривались о встрече,
              Вы сказали, что спешите на компьютерные курсы…
            </h2>
      ...
      <label for="read-more-checker2" class="read-more-button"></label>
