...
import a13 from "../../assets/mp3/dialog/13.mp3";
...
function AudioDialog() {
  ...
  const [audio13] = useState(new Audio(a13));
  const [audio14] = useState(new Audio(a14));
  const [audio15] = useState(new Audio(a15));

  return (
    <div className="audioDialog" id='audioDialog'>
      <div className="audioDialog-content">
        <h1 id="h1">Жизнь продолжается!</h1>
        <strong>Интервью-диалог с малолетним узником фашизма </strong>
        <strong>Глевацким Анатолием Владимировичем</strong>
        <h2>Знакомство</h2>
        ...
        <Accordions
          title="Читать"
          body={<p id='p'>Сегодня у нас в гостях малолетний узник концентрационного лагеря «Освенцим» Анатолий Владимирович Глевацкий. Он у нас работал мастером производственного обучения  - Здравствуйте, уважаемый Анатолий Владимирович! Мы благодарны, что Вы нашли время и желание пообщаться с нами, рассказать о себе!
            Так уж устроен человек, что со временем в его сознании боль от любой потери стихает, сглаживается. С годами самые тяжелые воспоминания становятся частью прошлого, которое принадлежит памяти, а к настоящему отношения уже не имеет. Это помогает пережить утрату, сохранить себя для будущей жизни. Механизм самосохранения работает бесперебойно, стирая память, утешая, оправдывая, облегчая... Человечеству в целом иной раз свойственна та же спасительная забывчивость. Однако в этом не только спасение, но и гибель - забывая об ужасах, которые происходили в прошлом, мы готовим их повторение. Вот поэтому учащиеся нашего лицея и, в частности члены волонтёрской группы «Луч добра», стараются сохранить память, дабы не увидеть и не ощутить тех ужасов войны, которые выпали на Вашу долю.
            В начале нашей беседы, просим Вас рассказать: где  и когда Вы родились, в какой семье?
            - Родился я в Спасском городке, районе нынешнего города Полоцка, 17 июля 1941 года, в семье молодого военного Глевацкого  Владимира Марковича и телефонистки Войцеховской (девичья фамилия) Галины Матвеевны. Молодая семья Глевацких поселилась в доме моего дедушки по материнской линии, где проживали не только дедушка и бабушка, но  ещё три сестры и брат матери.</p>
          }
        />
        <h2>
        ...
        <Accordions
          title="Читать"
          body="- Понятно, что с первых дней войны отец ушёл на фронт. Вскоре беда постучалась и в дом Войцеховских: кто-то донёс, что муж Галины – военный офицер. Вся семья была арестована. Есть ещё одна версия случившемуся: дедушка был связан с подпольщиками,  которые планировали передать партию валенок партизанам. Каким-то образом это стало известно фашистам. Так, осенью 1942 года вся наша семья была отправлена в тюрьму в район Задвинья.        - В начале 1943 года  дедушку казнили, а нас всех отправили в железнодорожный пункт в Громы для последующей отправки в лагерь. Так мы попали в 9-ый Минский эшелон, где в товарных вагонах везли людей из разных городов Витебской области и Беларуси. Ехали мы в тяжёлых условиях: в тесноте, без воды, делились едой с теми, кто успел её взять. Так мы ехали суток трое, останавливаясь только для того, чтобы выбросить умерших. И вот, 04. 12. 1943 мы с матерью и все родные попали в Освенцим, а конкретно в лагерь Аушвиц II - Биркенау. Заключённые сразу проходили обработку: их мыли, обривали волосы, одевали в полосатую одежду, ставили номер на руку…  (Анатолий Владимирович показал номер на руке, цифры которого,  по мере взросления,  расползлись на всё запястье). "
        />
        <h2>
        ...
        />
        <h2> - И куда же решил пойти выпускник?</h2>
        ...
        />
        <h2>- Наверное, переживали по этому поводу?</h2>
        ...
        />
        <h2>- Анатолий Владимирович, как же дальше сложилась Ваша судьба?</h2>
...
"
        ...
        <h2>
          {" "}
          - Анатолий Владимирович, расскажите, пожалуйста, о своей семье.
        </h2>
        <Button onClick={() => audio13.play()}>Слушать</Button>
        <Button onClick={() => audio13.pause()}>Пауза</Button>
        <Button
          onClick={() => {
            audio13.pause();
        ...
        <Accordions
          title="Читать"
          body="- Жену мою звали Галина Ивановна, работала она в общежитии треста воспитателем, затем в детском саду № 2 до самой пенсии. В следующем году  у нас была бы золотая свадьба…К сожаленью,  её  не стало три года назад…
У меня есть дочь, сын, двое внуков.
"
        />
        <h2>
