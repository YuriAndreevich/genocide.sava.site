  ...
  return (
    <div className="audioDialog" id='audioDialog'>
      <div className="audioDialog-content">
        ...
        <strong>{t('Интервью-диалог с малолетним узником фашизма Глевацким Анатолием Владимировичем')} </strong>
        ...
        <Accordions
          title="Читать"
          body={<><p id='p'>{t('Сегодня у нас в гостях малолетний узник концентрационного лагеря «Освенцим» Анатолий Владимирович Глевацкий. Он у нас работал мастером производственного обучения')}</p><p id='p'>{t(' - Здравствуйте, уважаемый Анатолий Владимирович! Мы благодарны, что Вы нашли время и желание пообщаться с нами, рассказать о себе! Так уж устроен человек, что со временем в его сознании боль от любой потери стихает, сглаживается. С годами самые тяжелые воспоминания становятся частью прошлого, которое принадлежит памяти, а к настоящему отношения уже не имеет. Это помогает пережить утрату, сохранить себя для будущей жизни. Механизм самосохранения работает бесперебойно, стирая память, утешая, оправдывая, облегчая... Человечеству в целом иной раз свойственна та же спасительная забывчивость. Однако в этом не только спасение, но и гибель - забывая об ужасах, которые происходили в прошлом, мы готовим их повторение. Вот поэтому учащиеся нашего лицея и, в частности члены волонтёрской группы «Луч добра», стараются сохранить память, дабы не увидеть и не ощутить тех ужасов войны, которые выпали на Вашу долю. В начале нашей беседы, просим Вас рассказать: где  и когда Вы родились, в какой семье?')}</p> <p id='p'>{t('- Родился я в Спасском городке, районе нынешнего города Полоцка, 17 июля 1941 года, в семье молодого военного Глевацкого  Владимира Марковича и телефонистки Войцеховской (девичья фамилия) Галины Матвеевны. Молодая семья Глевацких поселилась в доме моего дедушки по материнской линии, где проживали не только дедушка и бабушка, но  ещё три сестры и брат матери.')}</p></>
        }/>
        <h2 id='p'>
        ...
        />
        <h2 id='p'>- Анатолий Владимирович, как же дальше сложилась Ваша судьба?</h2>
