  ...
  return (
    <div className="genocide" id="genocide">
      <div data-aos="fade-right" data-aos-delay="300">
        <div className="genocide-content">
          <div class="readMore">
            <input
              type="checkbox"
